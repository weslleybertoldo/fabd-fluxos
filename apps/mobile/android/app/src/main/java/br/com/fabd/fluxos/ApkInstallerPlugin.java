...
/**
 * Atualizacao in-app: baixa o APK da release dentro do proprio app (com
 * progresso) e dispara o instalador do sistema. No Android, instalar um APK
 * sempre passa pela tela "Instalar?" do PackageInstaller — nao ha instalacao
 * silenciosa pra apps fora da Play Store (so device-owner/root).
 */
...
public class ApkInstallerPlugin extends Plugin {
    ...
    /** Permissao de instalar apps de fontes desconhecidas (Android 8+). */
    @PluginMethod()
    ...
    /** Abre as configuracoes pra liberar instalacao de fontes desconhecidas. */
    @PluginMethod()
    ...
    /** Dispara o instalador do sistema pro APK ja baixado. */
    @PluginMethod()
